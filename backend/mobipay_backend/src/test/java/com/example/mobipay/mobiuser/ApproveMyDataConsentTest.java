...
public class ApproveMyDataConsentTest {
    ...
    @Test
    @DisplayName("[OK] approve my data consent: 소유한 카드 조회 동의")
    void 올바른_소유한_카드_조회_동의_테스트() throws Exception {
        ...
        result.andExpect(status().isOk())
                ...
                .andExpect(jsonPath("$.myDataConsent").value(true));
    }

    @Test
    @DisplayName("[Not Found] approve my data consent: 소유한 카드 조회 동의(존재하지 않는 유저)")
